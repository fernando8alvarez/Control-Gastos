...
export default function Modal({ setModal, animateModal, setAnimateModal, saveExpend, EditSpent, setEditSpent, setFilters }) {
    ...
    return (
        <div className='modal'>
            ...
            <form
                ...
                <legend>{Object.keys(EditSpent).length > 0 ? "Editando Gasto" : "Nuevo Gasto"}</legend>
                ...
                <div className='campo'>
                    ...
                    <input
                        ...
                        value={cantidad}
                        onChange={e => setCantidad(e.target.value === "" ? e.target.value : Number(e.target.value))}
                    />
                </div>
                ...
                <input type="submit" value={Object.keys(EditSpent).length > 0 ? "Guardar Cambios" : "Añadir Gasto"} />
